...
// Additional Fork by nicoversity [ https://github.com/nicoversity/ ]
// Retrieved: 2020-02-18 via
// https://gist.github.com/R-WebsterNoble/70614880b0d3940d3b2b741fbbb311a2
// Edits compared to prior fork conducted on 2020-02-19 by nicoversity; marked within the script as 'NICOVERSITY-EDIT'
...
public static class SavWav
{
    ...
    public static void Save(string filename, AudioClip clip, bool trim = false)
    {
        ...
        {
            //var wav = GetWav(clip, out var length, trim);     // 2020-02-19 NICOVERSITY-EDIT: Unity error ->  Feature `out variable declaration' cannot be used because it is not part of the C# 6.0 language specification
            uint length;
    ...
    {
        //var data = ConvertAndWrite(clip, out length, out var samples, trim);      // 2020-02-19 NICOVERSITY-EDIT: Unity error ->  Feature `out variable declaration' cannot be used because it is not part of the C# 6.0 language specification
        uint samples;
